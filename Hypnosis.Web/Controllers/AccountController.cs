...
using Hypnosis.Filters;
using Hypnosis.Models;
using CustomMembershipEF.Interfaces;
using CustomMembershipEF.Services;

namespace Hypnosis.Controllers
{
    [Authorize]
    ...
    public class AccountController : Controller
    {
        ...
        //        ViewBag.ReturnUrl = returnUrl;
        //        return View("ExternalLoginConfirmation", new RegisterExternalLogOnModel { UserName = result.UserName, ExternalLoginData = loginData });
        //    }
        //}
        ...
        //[AllowAnonymous]
        //[ValidateAntiForgeryToken]
        //public ActionResult ExternalLoginConfirmation(RegisterExternalLogOnModel model, string returnUrl)
        //{
