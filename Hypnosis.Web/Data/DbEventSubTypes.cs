...
namespace Hypnosis.Web.Data.DbOperations
{
    public class DbEventSubTypes: OperationBase
    {
        ...
        public  IQueryable<EventTypesRowViewModel> GetRows(IQueryable<EventSubType> data)
        {
            return from c in data
                   ...
                   select new EventSubTypesRowViewModel
                   {
                       ...
                       Type_ID = c.Type_ID,
                       Type_Name=c.EventTypes.Type_Name
                   };
        }
        ...
        public s2result getEventSubTypes(string q, int page, int page_limit)
        {
